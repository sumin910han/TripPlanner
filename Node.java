  ...
  public boolean equals(Object o) {
    ...
    if (o != null) {
      ...
      if (o instanceof Node) {
        ...
        // compare node names
        if (name == null) {
          sameName = ((Node) o).getName() == null;
        } else {
          sameName = name.equals(((Node) o).getName());
        }
        // compare node descriptions
        if (description == null) {
          sameDescription = ((Node) o).getDescription() == null;
        } else {
          sameDescription = description.equals(((Node) o).getDescription());
        }
